...
var _postcssModulesResolvePath = _interopRequireDefault(require("postcss-modules-resolve-path"));
...
var _default = (cssSourceFilePath, options) => {
  ...
  const plugins = [...extraPlugins, _postcssModulesValues.default, _postcssModulesLocalByDefault.default, new _postcssModulesResolvePath.default({
    paths: options.searchPaths
  }), _postcssModulesExtractImports.default, new _postcssModulesScope.default({
    generateScopedName
